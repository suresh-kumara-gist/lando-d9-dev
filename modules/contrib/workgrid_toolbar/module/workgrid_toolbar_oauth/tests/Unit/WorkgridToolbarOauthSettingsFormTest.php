...
use Drupal\workgrid_toolbar_oauth\Form\SettingsForm;
 ...
 */
class WorkgridToolbarOauthSettingsFormTest extends UnitTestCase {
   ...
   *
   * @var \Drupal\workgrid_toolbar_oauth\Form\SettingsForm
   */
  private $form;
  ...
  public function testFormId() : void {
    $this->assertEquals('workgrid_toolbar_oauth_settings', $this->form->getFormId());
  }
