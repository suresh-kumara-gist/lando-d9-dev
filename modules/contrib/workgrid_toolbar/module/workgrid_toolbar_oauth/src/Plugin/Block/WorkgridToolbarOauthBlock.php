...
namespace Drupal\workgrid_toolbar_oauth\Plugin\Block;
...
/**
 * Provides an Workgrid Toolbar Oauth block.
 *
 * @Block(
 *   id = "workgrid_toolbar_oauth",
 *   admin_label = @Translation("Workgrid Toolbar Oauth"),
 *   category = @Translation("Workgrid Toolbar Oauth")
 * )
 */
class WorkgridToolbarOauthBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    $workgrid_toolbar_config = $this->configFactory->get('workgrid_toolbar_oauth.settings');
    $build['content'] = [
      '#attached' => [
        'drupalSettings' => [
        ...
        'library' => [
          'workgrid_toolbar_oauth/workgrid_toolbar_oauth',
        ],
      ],
    ];
    return $build;
